    ...
    >
      <div className="container px-4" style={{ maxWidth: "800px" }}>
        <div className="text-center">
          ...
          <h1 className="fw-bold mb-4" style={{ fontSize: "2.2rem", lineHeight: "1.3" }}> {/* added extra bottom margin */}
            I'm a <span className="text-warning">Java Fullstack Developer</span>
          </h1>

          <p className="mb-1" style={{ fontSize: "1rem", color: "#f9f4f4", lineHeight: "1.8" }}> {/* increased line height and bottom margin */}
